...
then upward) to the nominal operating point within 0.5\,s. Peak
tracking disturbance across the episode was 0.12\,m. Trigger, binding,
yielding, clearing, and floor-mediated recovery are thus each observed
in flight, in their specified priority order.
